...
function renderHome() {
  const topicsData = [
    ...
    { id: 'structural',  icon: '⬡', accent: '#a78bfa', title: 'Pattern Strutturali', count: '4 pattern', desc: 'Decorator, Adapter, Facade, Composite' },
    { id: 'behavioral',  icon: '⟳', accent: '#a78bfa', title: 'Pattern Comportamentali', count: '5 pattern', desc: 'Strategy, Observer, Command, Chain' },
    { id: 'behavioral',  icon: '⟳', accent: '#a78bfa', title: 'MVC', count: '3 sezioni', desc: 'Controller, Service, Entity' },
